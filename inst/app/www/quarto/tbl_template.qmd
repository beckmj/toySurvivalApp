...
note, exporting ggplot can be finicky.  Please select the "Editable Plots" export
option to see two methods of generating plots that can be manipulated outside of
R.
```{r}
#| echo: false
#| message: false
